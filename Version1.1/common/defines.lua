...
NDiplomacy = {
	...
	TRADE_LEAGUE_MIN_PRESTIGE_OLD_LEADER = -20,		-- Minimum required prestige to stay leader of a Trade League.
	...
	TRADE_LEAGUE_BREAK_OPINION = -20,				-- AI will leave a Trade League if their opinion of you falls below this value.
	...
	DAYS_TO_DECLARE_WAR = 180,						-- Days from start of game before you can DOW anyone

	INCREASE_TRUST_COST = 10,						-- Cost in favors to increase trust
	INCREASE_TRUST_AMOUNT = 5,						-- Amount of trust per increase
	PREPARE_FOR_WAR_COST = 3,						-- Cost in favors to ask AI to prepare for war
	...
	BUILD_SPY_DISCOVERED_PENALTY = -25.0,
	...
	SUPPORT_REBELS_EFFECT = 20,
	SUPPORT_REBELS_MONEY_FACTOR = 0.25,
	...
	AE_OTHER_CONTINENT = 15,
	AE_SAME_CULTURE = 0.75,
	AE_SAME_CULTURE_GROUP = 0.50,
	AE_INFIDEL_CONQUEST = 0.50, 		-- different religion group conquered same religion province
	AE_SAME_RELIGION = 0.75,
	...
	PO_DEMAND_PROVINCES_AE = 1, 				-- _DDEF_PO_DEMAND_PROVINCES_AE = 10, (Per development)
	...
	PO_REVOKE_CORES_PRESTIGE = 0.5, 					-- _DDEF_PO_REVOKE_CORES_PRESTIGE = 10, (Per development)
	PO_RETURN_CORES_PRESTIGE = 0.5, 					-- (Per development)
	...
	PO_CHANGE_RELIGION_PRESTIGE = 15, 				-- _DDEF_PO_CHANGE_RELIGION_PRESTIGE = 10,
	PO_FORM_PU_PRESTIGE = 0.25, 						-- _DDEF_PO_FORM_PU_PRESTIGE = 10,
	PO_BECOME_VASSAL_PRESTIGE = 0.15, 					-- _DDEF_PO_BECOME_VASSAL_PRESTIGE = 10,
	...
	PO_ANNUL_TREATY_PRESTIGE = 2, 					-- _DDEF_PO_ANNUL_TREATY_PRESTIGE = 10,
	PO_REVOKE_ELECTOR_AE = 25,
	PO_REVOKE_ELECTOR_PRESTIGE = 5,
	PO_TRADE_POWER_PRESTIGE = 2,
	PO_CONCEDE_COLONIAL_PRESTIGE = 2,
	PO_GIVE_UP_CLAIM_PRESTIGE = 5,
	PO_HUMILIATE_RIVAL_PRESTIGE = 10,
	PO_FORCE_MIGRATION_PRESTIGE = 2,
	PO_ENFORCE_REBEL_DEMANDS_PRESTIGE = 5,
	PO_TAKE_MANDATE_PRESTIGE = 25,
	PO_TAKE_MANDATE_AE = 0,

	PO_ENFORCE_FLEET_BASING_PRESTIGE = 5,
	PO_ENFORCE_MIL_ACCESS_PRESTIGE = 5,
	...
	PEACE_COST_CONCEDE_PROVINCE = 2,				-- Demand colonial area province concession.
	...
	PEACE_COST_HUMILIATE_RIVAL = 30,
	PEACE_COST_FORCE_MIGRATION = 100.0,
	PEACE_COST_ENFORCE_REBEL_DEMANDS = 30,
	...
	PEACE_COST_DEMAND_NON_OCCUPIED_PROVINCE_MULT = 2,
	PEACE_COST_DEMAND_CAPITAL_MULT = 2,
	...
	ALLY_PEACE_COST_MULT = 4,						-- Taking things from allies that are not fully called into the war costs this much more
	ALLY_AE_MULT = 3,								-- Taking things from allies that are not fully called into the war generates this much more AE

	ANNEX_DIP_COST_PER_DEVELOPMENT = 16,			-- per development

	DEFENDER_AE_MULT = 0.9, 					-- _DDEF_DEFENDER_AE_MULT_ (Infamy multiplied by this for defenders in peace treaties, unless the CB is "mutual" )
	...
	CLAIM_PEACE_COST_DIP_FRACTION = -0.2,			-- Fraction of dipcost you pay for claims
	CORE_PEACE_COST_DIP_FRACTION = -0.4,			-- Fraction of dipcost you pay for cores
	...
	MIN_RELATIONS_TO_ALLY = 75,						-- Alliances not possible if either country has an opinion of the other lower than this
	...
	INTEGRATE_VASSAL_MIN_YEARS = 15,				-- Number of years before a vassal can be integrated
	...
	DIPLOANNEX_LIBERTY_THRESHOLD = 35,				-- If a vassal has >= this much liberty desire, there will be zero diploannexation progress.
	...
	ABANDON_UNION_PRESTIGE = -100,					-- The change in prestige for the overlord when abandoning a personal union.
	...
	FORCE_END_RIVALRY_YEARS = 20,					-- Years until you can re-add a Rival after being forced to remove them by peace treaty.
...
NCountry = {
	...
	EMBRACE_INSTITUTION_COST = 3,				-- 2.5 per development (autonomy modified)
	...
	STATE_MAINTENANCE_DISTANCE_FACTOR = 0.003,	-- distance
	STATE_MAINTENANCE_CONTINENT_FACTOR = 0.5,	-- different continet
	STATE_MAINTENANCE_CULTURE_FACTOR = 5,		-- non accepted culture
	...
	ESTATE_GRANT_PROVINCE_COOLDOWN = 3,			-- A province cannot be revoked for this amount of years after being granted to an estate
	...
	MIN_PRESTIGE_FOR_GOV_RANK_2 = 40,			-- Required prestige to to upgrade to government rank 2
	MIN_PRESTIGE_FOR_GOV_RANK_3 = 60,			-- Required prestige to to upgrade to government rank 3
	...
	PS_BUY_EXPLORER = 50,
	PS_ASSAULT = 5,
	PS_ARTILLERY_BARRAGE = 60,
	PS_NAVAL_BARRAGE = 20,
	PS_FORCE_MARCH = 4,
	PS_DEMAND_NON_WARGOAL_PROVINCE = 75,
	PS_DEMAND_NON_WARGOAL_PEACE = 5,
	PS_DEMAND_NON_WARGOAL_PEACE_PRIMITIVES = 0,
	PS_MAKE_PROVINCE_CORE = 13,
	...
	PS_ADD_ACCEPTED_CULTURE = 700,
	PS_REMOVE_ACCEPTED_CULTURE = 300,
	PS_REMOVE_ACCEPTED_CULTURE_UNREST_DURATION = 10,
	PS_STRENGTHEN_GOVERNMENT = 200,
	PS_BOOST_MILITARIZATION = 400,
	...
	UNREST_REVOLT_FACTOR = 0.75, -- How much does each point of unrest contribute to chance of revolt uprising increasing (base)
	...
	LAGGINGTECH_CORRUPTION = 0.3,					-- Corruption increase/year. Multiplied by (highest - lowest) tech level
	LAGGINGTECH_CORRUPTION_MAX = 1.5,				-- Max increase/year
	...
	OVEREXTENSION_FACTOR = 2.0,
	OVEREXTENSION_OVERSEAS_FACTOR = 0.75,			-- Modifier to overextension from overseas provinces
	...
	STARTING_ARMY_SIZE_REBEL_THREAT = 0.15,			-- Percentage of rebel threat added to percentage of force limit
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.5,		-- Multiplied with the province's development
	REVOLT_SIZE_BASE = 4,
	REVOLT_TECH_IMPACT = 0.05, 			-- % each tech increases size of rebels by this percent.
	REVOLT_TECH_MORALE = 0.02,			-- 1% per tech level
	...
	MAX_FERVOR = 100.0,
	BREAK_ALLIANCE_PRESTIGE_LOSS = 5.0,			-- This is the amount of Prestige you lose if someone declines your Break Alliance demand.
	...
	INNOVATIVENESS_FIRST_PICKED_IDEA = 3.0,			-- Innovativeness bonus to first country (or countries) to pick an idea.
...
NEconomy = {
	...
	AUTONOMY_AT_DIPLO_ANNEX = 85,					-- Autonomy added when diplo-annexing
	AUTONOMY_AT_CONQUEST = 80,						-- Autonomy added at conquest
	AUTONOMY_AT_CONQUEST_CLAIM = 60,				-- Autonomy added at conquest if you have a claim
	AUTONOMY_AT_CONQUEST_CORE = 40,					-- Autonomy added at conquest if you have a core
	...
	INFLATION_FROM_PEACE_GOLD = 0.1,				-- inflation per month of income taken in peace (also applied to province sales)
	INFLATION_ACTION_REDUCTION = 2,					-- amount per action
	BANKRUPTCY_DURATION = 10,						-- _EDEF_BANKRUPTCY_DURATION_
	BANKRUPTCY_BUILDING_DESTRUCTION_THRESHOLD = 10,	-- Bankruptcy will destroy building that have been build in the latest X amount of years. Set to zero to disable the destruction mechanic.
...
NMilitary = {
	...
	FORT_DEVASTATION_IMPACT = -5,				-- multiplied by fortlevel/max fortlevel in area per year.
	REVANCHISM_DEVASTATION_IMPACT = -0.02,			-- 100 revanschism is -2 a year.
	SURRENDER_DEVASTATION_IMPACT = -1.7,
	CONTROL_DEVASTATION_IMPACT = -.5,				-- devastation recovery given by control
	...
	SIEGE_ATTRITION = 1,
	SIEGE_DISEASE_IMPACT = 0.10,						-- Fraction of besieging soldiers lost in a disease outbraek
	...
	MERCENARY_BASE_COST = 20.0,					-- base cost added for a mercenary regiment
	...
	LOOT_DEVASTATION_IMPACT = 15,						-- how much devastation full loot impacts
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.5,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	WARGOAL_MAX_BONUS = 30,
	...
	REBEL_LEADER_POWER = 25,							-- The higher this value, the more pips rebel leaders will have on average
	...
	CAV_SUPPRESSION = 0.50,						-- The amount of reduction to unrest for each friendly cavalry regiment in a province
...
NAI = {
	ACCEPTABLE_BALANCE_DEFAULT = 1.5, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	...
	POWERFUL_ALLY_PENALTY = 100,	-- Penalty on alliance for them already having a powerful ally if much stronger
	RIVAL_ALLIANCE_PENALTY = 125, -- Penalty on alliance chance for being allied to rivals
